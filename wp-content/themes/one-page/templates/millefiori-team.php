        ...
        <div>
          <div class="col-xs-6">
            <div class="team-cell team-cell1" <?php echo onepage_get_option('onepage_team1_image') ?
                'style="background-image: url(' . onepage_get_option('onepage_team1_image', '') . ')"' : ''; ?>></div>
          ...
          <div class="col-xs-6">
              <div class="team-cell team-cell2" <?php echo onepage_get_option('onepage_team2_image') ?
                  'style="background-image: url(' . onepage_get_option('onepage_team2_image', '') . ')"' : ''; ?>></div>
          ...
          <div class="col-xs-6">
              <div class="team-cell team-cell3" <?php echo onepage_get_option('onepage_team3_image') ?
                  'style="background-image: url(' . onepage_get_option('onepage_team3_image', '') . ')"' : ''; ?>></div>
          ...
          <div class="col-xs-6">
              <div class="team-cell team-cell4" <?php echo onepage_get_option('onepage_team4_image') ?
                  'style="background-image: url(' . onepage_get_option('onepage_team4_image', '') . ')"' : ''; ?>></div>
