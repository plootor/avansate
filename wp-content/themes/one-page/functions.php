...
function onepage_styles() {
    ...
    wp_enqueue_style('one-page-bootstrap',ONEPAGE_DIR_URI . 'assets/css/bootstrap.min.css');
    /**
     * Homepage hexagonal gallery CSS file
     */
    wp_enqueue_style('one-page-hexagonal', ONEPAGE_DIR_URI . 'assets/css/mille-fiori.css');
    ...
    if (onepage_get_option('onepage_animation_status') == 'on') {
        //put here css related to animation to be able on/off it
    }
}
...
function onepage_scripts() {
  ...
  wp_enqueue_script('one-page-bootstrap', ONEPAGE_DIR_URI . 'assets/javascript/bootstrap3.3.7.js', array(), '', true);

  wp_enqueue_script('one-page-imagesloaded', ONEPAGE_DIR_URI . 'assets/javascript/imagesloaded.pkgd.min.js', array(), '', true);

  wp_enqueue_script('one-page-masonry', ONEPAGE_DIR_URI . 'assets/javascript/masonry.pkgd.min.js', array(), '', true);

  wp_enqueue_script('one-page-easing', ONEPAGE_DIR_URI . 'assets/javascript/jquery/jquery.easing.min.js', array('jquery'), '', true);

  wp_enqueue_script('one-page-viewportchecker', ONEPAGE_DIR_URI . 'assets/javascript/jquery/jquery.viewportchecker.js', array('jquery'), '', true);

  wp_enqueue_script('one-page-bcswipe', ONEPAGE_DIR_URI . 'assets/javascript/jquery/jquery.bcSwipe.min.js', array('jquery'), '', true);

  wp_enqueue_script('one-page-bootstrap-validation', ONEPAGE_DIR_URI . 'assets/javascript/jqBootstrapValidation.js', array('one-page-bootstrap'), '', true);

  wp_enqueue_script('one-page-main', ONEPAGE_DIR_URI . 'assets/javascript/main.js', array('jquery'), '', true);
    /**
