...
function millefiori_latestpost_section() {
  get_template_part('templates/millefiori', 'latestpost');
}

function millefiori_story_section() {
  get_template_part('templates/millefiori', 'story');
}

function millefiori_team_section() {
  get_template_part('templates/millefiori', 'team');
}

function millefiori_quote_section() {
  get_template_part('templates/millefiori', 'quote');
}

function millefiori_services_section() {
  get_template_part('templates/millefiori', 'services');
}

function millefiori_newsletter_section() {
  get_template_part('templates/millefiori', 'newsletter');
}

function millefiori_portfolio_section() {
  get_template_part('templates/millefiori', 'portfolio');
}

function millefiori_partners_section() {
  get_template_part('templates/millefiori', 'partners');
}

function millefiori_testimonials_section() {
  get_template_part('templates/millefiori', 'testimonials');
}

function millefiori_contact_section() {
  get_template_part('templates/millefiori', 'contact');
}
